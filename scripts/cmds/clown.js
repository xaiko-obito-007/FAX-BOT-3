...
module.exports = {
  config: {
    ...
    author: 'Rasin',
    prefix: false,
    description: 'This person is a clown!',
    category: 'fun',
    usages: ['clown @mention / reply / uid / fb link']
  },
  ...
  onStart: async function ({ api, event, args, message, usersData }) {
    try {
      ...
      const url = `https://api.popcat.xyz/v2/clown?image=${encodeURIComponent(avt)}`;
      ...
      console.error(err);
      message.reply("❌ Failed to clown image.");
    }
  }
};
